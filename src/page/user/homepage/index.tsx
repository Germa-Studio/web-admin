    ...
    <UserLayout>
      <section className="pb-5 max-w-[80%] mx-auto">
        <div className="container mb-8">
          <div className="text-lg md:text-xl lg:text-2xl text-center font-bold mb-[5%]">
            Statistik Pertanian
          </div>
        ...
        <MainCard transparent noPadding>
          <div className="lg:flex justify-between">
            <MainCard transparent className="w-100 lg:w-[30%]">
              <div className="text-center text-base md:text-lg lg:text-xl font-semibold !capitalize">
                Musim Tanam Seluruh Komoditas
              </div>
              <PieChart apiData={respData?.summary ?? []} />
            </MainCard>
            <MainCard transparent className="w-100 lg:w-[60%]">
              <div className="text-center text-base md:text-lg lg:text-xl font-semibold !capitalize">
                statistik pertumbuhan pertanian
              </div>
