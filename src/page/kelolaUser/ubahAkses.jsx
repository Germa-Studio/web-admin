...
export default function UbahAkses() {
  ...
  const chooseBase =
    'rounded-ss-xl rounded-se-xl w-[50%] text-center h-fit py-2 w-[100%] min-w-8 font-bold text-white transition-all bg-orange-primary hover:bg-green-sidebar-hover duration-200 ease-in-out';
  const chooseActive =
    'rounded-ss-xl rounded-se-xl w-[50%] text-center h-12 w-[100%] min-w-8 font-bold text-white transition-all bg-[#307B28] hover:bg-green-sidebar-hover duration-200 ease-in-out';
